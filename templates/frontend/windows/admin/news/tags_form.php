<div ui-window="admin.news.tags_form" style="width: 650px">
	...
	<div class="mt15 fs14">
		...
		<div class="mt15">
			<table data-ui="list">
				...
				<script type="text/x-kendo-template">
					<div class="p10">
						<a data-action="edit" data-id="#=id#" href="javascript:void(0);">#=name#</a>
					</div>
				</script>
				<script type="text/x-kendo-template">
					<div class="tacenter">
				...
				<script type="text/x-kendo-template">
					<div class="tacenter">
						<a data-action="delete" data-id="#=id#" data-text="<?=t("Ви дійсно бажаєте видалити цю категорію?")?>" href="javascript:void(0);"><?=t("Видалити")?></a>
					</div>
				</script>
				<script type="text/x-kendo-template">
					<tr>
