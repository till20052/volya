<div ui-window="admin.agitations.categories" style="width: 700px">
	...
	<div class="mt10">
		<table id="list">
			<script type="text/x-kendo-template">
				<div style="padding:0 10px;line-height:normal">
					<div style="padding:10px 0">
						<a href="javascript:void(0)" ui="symlink" data-id="#=id#">#=(symlink != "" ? symlink : "[ no value ]")#</a>
					</div>
				</div>
			</script>
			<script type="text/x-kendo-template">
				<div style="padding:0 10px;line-height:normal">
					<div style="padding:10px 0">
						<a href="javascript:void(0)" ui="name" data-id="#=id#">#=(name.<?=Router::getLang()?> != "" ? name.<?=Router::getLang()?> : "[ no value ]")#</a>
					</div>
				</div>
			</script>
			<script type="text/x-kendo-template">
			...
			<script type="text/x-kendo-template">
				<div class="pl10 fs12">
					<div>
						<a href="javascript:void(0);" ui="remove" data-id="#=id#"><i class="icon-remove"></i></a>
					</div>
				</div>
			</script>
		</table>
