...
(function ($) {
	$.fn.jshowoff = function (settings) {
		var config = {
			...
			changeSpeed: 300,
			controls: false,
			controlText: {play: '►', pause: '||', next: 'Next', previous: 'Previous'},
			effect: 'slideLeft',
			hoverPause: false,
			links: true,
			speed: 2000
...
(function ($) {
	$.fn.slideIt = function (settings, callback) {
		var config = {direction: 'left', showHide: 'show', changeSpeed: 500};
		if (settings)$.extend(config, settings);
		this.each(function (i) {
			$(this).css({left: 'auto', right: 'auto', top: 'auto', bottom: 'auto', backgroundPosition: 'center'});
