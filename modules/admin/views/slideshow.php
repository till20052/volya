	...
	<div>
		<div>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<td>
					<h1>
						<a href="/admin">Адмін панель</a> / <?=t(SlideshowAdminController::$modAText)?>
					</h1>
				</td>
				<td class="taright">
		...
		<div>
			...
			<table id="list" width="100%">
				...
				<script type="text/x-kendo-template">
					<div class="p5 pl20">
						<div>
							<a href="javascript:void(0);" data-ui="edit" data-id="#=id#" class="icon">
								<i class="icon-pencil"></i>
								<span><?=t("Змінити")?></span>
							</a>
						</div>
						<div>
							<a href="javascript:void(0);" data-ui="remove" data-id="#=id#" class="icon">
