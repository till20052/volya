	...
	<div>
		<div>
			<table width="100%" cellpadding="0" cellspacing="0">
				<td>
					<h1>
						<a href="/admin">Адмін панель</a> / <?=t(EmailTemplatesAdminController::$modAText)?>
					</h1>
				</td>
				<td class="taright">
			...
			<table id="list" width="100%">
				...
				<script type="text/x-kendo-template">
					<div class="pl20" style="line-height:normal">
						<div class="fwbold">#=subject.<?=Router::getLang()?>#</div>
						<div class="fs12">#=symlink#</div>
						<div class="fs12"><?=t("Дата створення")?>: #=kendo.toString(kendo.parseDate(created_at), "HH:mm dd MMMM yyyy")#</div>
					</div>
				</script>
				<script type="text/x-kendo-template">
					<div class="p5 pl20">
