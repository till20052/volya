						...
						<div data-ui-block="news">
							...
							<section>
								...
								<div class="mt15 tacenter">
									<a data-action="load_next_news" href="javascript:void(0);" class="v-button v-button-blue"><?=t('Завантажити ще')?></a>
								</div>
								...
								<section>
									<ul>
										...
										<? foreach($keys as $__key){ ?>
											...
											<li data-vid="<?=$__item['id']?>">
												<div data-ui="preview" style="<? if(count($__item["images"]) > 0){ ?> background-image: url('http://volya.ua/s/img/thumb/200x/<?=$__item["images"][0]?>')<? } else { ?> background-image: url('/img/frontend/cells1/volya.logo.jpg')<? } ?>; width: 81px; height: 50px; background-size: contain; float: left;"></div>
